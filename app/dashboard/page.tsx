...
export default async function DashboardPage() {
  ...
  return <div className="dashboard-shell">
    <aside><div className="brand"><span className="logo">CP</span><strong>CashPatch</strong></div><nav><a className="active" href="/dashboard">Recovery queue</a><a href="/dashboard/sources">Sources</a><a href="/dashboard/reports">Reports</a></nav><div className="aside-bottom"><span>{workspace?.plan ?? 'trial'} plan</span><SignOutButton /></div></aside>
    <main className="dashboard-main">
      <header className="dash-head"><div><p className="eyebrow">{workspace?.name ?? 'Workspace'}</p><h1>Recover what slipped through.</h1></div><a className="scan-btn" href="/dashboard/sources">Connect sources</a></header>
